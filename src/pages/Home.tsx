...
const LoadingSpinner: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="relative w-20 h-20" role="status" aria-label="Loading products">
        <div
...
const Home: React.FC = () => {
  ...
  return (
    ...
    >
      <section className={`${theme.spacing.section} ${theme.spacing.container}`}>
        <div className="text-center">
          ...
          >
            Experience the power of dynamic theming with our multi-theme switcher.
            Choose from minimalist, dark sidebar, or colorful card layouts.
          </p>
          <button
